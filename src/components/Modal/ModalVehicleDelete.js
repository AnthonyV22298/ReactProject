...
const ModalVehicleDelete = (props) => {
  const {
    buttonLabel,
    className,
    targetfee,
  ...
  return (
    <div>
      ...
      <Modal isOpen={modal} toggle={toggle} className={className} targetfee={targetfee}>
        <ModalHeader toggle={toggle} style={{background:"#343a40", color:"white"}}>Are you sure you want to unregister this vehicle?</ModalHeader>
        <ModalBody>
...
export default ModalVehicleDelete;